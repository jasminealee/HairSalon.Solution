...
--
-- Host: localhost:8889
-- Generation Time: Mar 27, 2019 at 05:34 AM
...
--
CREATE DATABASE IF NOT EXISTS `jasmine_lee_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jasmine_lee_test`;
